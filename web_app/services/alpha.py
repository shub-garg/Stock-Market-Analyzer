...
ALPHAVANTAGE_API_KEY = "0JEGUHNKMWXS9B0P"
...
class AlphavantageService:
    ...
    def fetch_stocks_daily(self, symbol="MSFT"):
        ...
        """
        request_url = f"https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol={symbol}&apikey={self.api_key}&datatype=csv"
